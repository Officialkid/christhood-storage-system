...
export default function TransferShareViewClient({ code }: { code: string }) {
  ...
  if (step === 'pin') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 px-4 py-10">
        <div className="mx-auto max-w-md rounded-3xl border border-slate-800 bg-slate-900/80 p-8 shadow-2xl shadow-black/20">
          ...
          <section className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6 shadow-2xl shadow-black/20">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="rounded-2xl border border-slate-700 bg-slate-950/60 px-4 py-3 text-right">
                ...
                <p className="mt-1 text-lg font-semibold text-white">{transfer.bundleName}.zip</p>
              </div>
            </div>
